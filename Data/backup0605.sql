...
CREATE TABLE public.participation (
    parti_id character varying(6) NOT NULL,
    league_id character varying(6),
...
--
-- Name: premierleague_20232024; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.premierleague_20232024 AS
SELECT
...
ALTER TABLE public.premierleague_20232024 OWNER TO postgres;

--
-- Name: premierleague_20232024_ranking; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.premierleague_20232024_ranking AS
 SELECT premierleague_20232024.club_id,
    rank() OVER (ORDER BY premierleague_20232024.point DESC, premierleague_20232024.goal_diff DESC, premierleague_20232024.total_goals DESC) AS ranking
   FROM public.premierleague_20232024;


ALTER TABLE public.premierleague_20232024_ranking OWNER TO postgres;
...
COPY public.match (match_id, league_id, parti_id, round, date_of_match, stadium, referee) FROM stdin;
#MUNLIV240407	EL0001	\N	32	2024-04-07	Old Trafford	Anthony Taylor\t
#MCIARS240331	EL0001	\N	30	2024-03-31	Etihad Stadium	Anthony Taylor\t
#LIVMCI240310	EL0001	\N	28	2024-03-10	Anfield	Michael Oliver\t
#MCIMUN240303	EL0001	\N	27	2024-03-03	Etihad Stadium	Andy Madley\t
#MCICHE240218	EL0001	\N	25	2024-02-18	Etihad Stadium	Andy Madley\t
#ARSLIV240204	EL0001	\N	23	2024-02-04	Emirates Stadium	Anthony Taylor\t
#LIVMUN231217	EL0001	\N	17	2023-12-17	Anfield	Michael Oliver\t
#MCITOT231203	EL0001	\N	14	2023-12-03	Etihad Stadium	Simon Hooper\t
#MCILIV231125	EL0001	\N	13	2023-11-23	Etihad Stadium	Chris Kavanagh\t
#CHEMCI231112	EL0001	\N	12	2023-11-12	Stamford Bridge	Anthony Taylor\t
#TOTCHE231107	EL0001	\N	11	2023-11-07	Tottenham Stadium	Michael Oliver\t
#MUNMCI231029	EL0001	\N	10	2023-10-29	Old Trafford	Paul Tierney\t
#ARSMCI231008	EL0001	\N	8	2023-10-08	Emirates Stadium	Michael Oliver\t
#TOTLIV230930	EL0001	\N	7	2023-09-30	Tottenham Stadium	Simon Hooper\t
#ARSTOT230924	EL0001	\N	6	2023-09-24	Emirates Stadium	Robert Jones\t
#ARSMUN230903	EL0001	\N	4	2023-09-03	Emirates Stadium	Anthony Taylor\t
#CHELIV230813	EL0001	\N	1	2023-08-13	Stamford Bridge	Anthony Taylor\t
#MUNLIV240317	EL0002	\N	Tứ kết	2024-03-17	Old Trafford	John Brooks\t
#MCICHE240420	EL0002	\N	Bán kết 	2024-04-20	Wembley	Michael Oliver\t
#CHELIV240225	EL0003	\N	Chung kết	2024-02-25	Wembley	Chris Kavanagh\t
#RMABAR240422	SL0001	\N	32	2024-04-22	Santiago Bernabéu	Cesar Soto Grado\t
#ATMBAR240318	SL0001	\N	29	2024-03-18	Citivas Metropolitano	Jose Martinez\t
#RMAATM240205	SL0001	\N	23	2024-02-05	Santiago Bernabéu	Jose Martinez\t
#BARRMA231028	SL0001	\N	11	2023-10-28	Estadi Olimpic Lluis Companys	Jesus Manzano\t
#LEVBAY240211	GL0001	\N	21	2024-02-21	BayArena	Felix Zwayer\t
#BAYDOR240331	GL0001	\N	27	2024-03-31	Allianz Arena	Harm Osmers\t
#DORLEV20240421	GL0001	\N	30	2024-04-21	Signal Iduna Park	Daniel Siebert\t
#ARSCHE24/4/24	EL0001	\N	29	2024-04-24	Emirates Stadium	Simon Hooper\t
\.
...
COPY public.participation (parti_id, league_id, club_id, season) FROM stdin;
\.
...
--
-- Name: premierleague_20232024 _RETURN; Type: RULE; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW public.premierleague_20232024 AS
 SELECT club.club_id,
    club.club_name,
    sum(
        CASE
   ...
   FROM ((((public.match
     ...
     JOIN public.participation ON (((match.parti_id)::text = (participation.parti_id)::text)))
  WHERE (((match.league_id)::text = 'EL0001'::text) AND ((participation.season)::text = '2023-2024'::text))
...
--
-- Name: match match_parti_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.match
    ADD CONSTRAINT match_parti_id_fkey FOREIGN KEY (parti_id) REFERENCES public.participation(parti_id);
